		...
		<section>
			<section className='flex flex-cols-2 gap-10 my-5'>
				<Card>
					...
					<CardContent>
						<p>
							Simen a été mon tech lead pendant mon alternance. Il
							a assuré mon intégration au sein de l&apos;équipe
							ainsi que mon évolution technique et professionnelle
							grâce aux projets qu&apos;il m&apos;a confié.
						</p>
					</CardContent>
				...
				<Card>
					...
					<CardContent>
						<p>
							Goulwen a été mon PM au cours de mon alternance. Il
							a choisi les sujets sur lesquels j&apos;ai été
							amenée à travailler et m&apos;a aussi fait découvrir
							les enjeux de son rôle et la relation entre nos deux
							métiers.
						</p>
					</CardContent>
					<CardFooter className='gap-5'>
